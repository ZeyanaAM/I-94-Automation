(function(){
	...
	'use strict';
	angular.module('i94').controller('ApplyPaymentFailureController', ApplyPaymentFailureController);
	
	ApplyPaymentFailureController.$inject = ['$translate', 'applicationService', '$state', '$uibModal'];
	
	function ApplyPaymentFailureController($translate, applicationService, $state, $uibModal) {
